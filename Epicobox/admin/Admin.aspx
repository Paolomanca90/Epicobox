     ...
     <div class="mb-3">
        ...
        <asp:TextBox class="form-control" id="nomeEsperienza" runat="server"></asp:TextBox>
         ...
         <asp:TextBox class="form-control" id="descrizioneLunga" runat="server"></asp:TextBox>
          ...
          <asp:TextBox type="text" class="form-control" id="prezzo" runat="server"></asp:TextBox>

         <asp:Label for="dataInizio" runat="server" class="form-label">Inserisci la Data di Inizio</asp:Label>
         <asp:TextBox type="date" class="form-control" id="dataInizio" runat="server"></asp:TextBox>

         <asp:Label for="dataFine" runat="server" class="form-label">Inserisci la Data di Fine</asp:Label>
         <asp:TextBox type="date" class="form-control" id="dataFine" runat="server"></asp:TextBox>
